...
//	            boolean answerIsTrue = (answers[currentIndex] == 0) ? false : true;
	            boolean answerIsTrue = convertIntResToBool(questions[currentIndex].getAnswer());
...
//        boolean answerIsTrue = (answers[currentIndex] == 0) ? false : true;
    	Log.d(TAG, Integer.toString(questions[currentIndex].getAnswer()));
    ...
    public boolean convertIntResToBool(int resId) {
